...
public class ExamController {
    ...
    public void add(@Valid @RequestBody ExamRequest examRequest, @Parameter(hidden = true) @AuthenticationPrincipal UserDetails userDetails){
        examService.add(examRequest, userDetails);
    }
