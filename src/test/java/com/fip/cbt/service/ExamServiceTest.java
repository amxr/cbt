...
//
//        Exam exam = examService.add(examRequest, userDetails);
//
...
//            examService.delete(id, userDetails);
//        });
//
...
//
//        Exam exam = examService.getOne(id, userDetails);
//
...
//
//        Exam exam = examService.update(updateExamRequest, userDetails);
...
//                                                          new Exam())
//        );
//        List<Exam> exams = examService.getAll(userDetails);
